...
class CoralSpeciesDBHelper {
  static final CoralSpeciesDBHelper instance = CoralSpeciesDBHelper.init();
  static Database? _database;

  CoralSpeciesDBHelper.init();

  Future<Database> get database async {
    if (_database != null) return _database!;
    _database = await _initDB('coral_species_actions.db');
    return _database!;
  }
  ...
  Future<void> insertAction(CoralSpecies species, String action) async {
