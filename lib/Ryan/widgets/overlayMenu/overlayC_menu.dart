...
import '../bottomSheets/shareC_options_bottom_sheet.dart';
import '../commentModal/commentC_modal.dart';
...
class _OverlayBackgroundMenuState extends State<OverlayBackgroundMenu>
  ...
  bool _isActive(String label, CoralSpeciesActionProvider provider) {
    switch (label) {
      case 'Save':
  ...
  int _getBadgeCount(String label, CoralSpeciesActionProvider provider) {
    switch (label) {
      case 'Comment':
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CoralSpeciesActionProvider>(
  ...
  Widget _buildOrbitItem({
    ...
    required CoralSpeciesActionProvider provider,
  }) {
    final double angle =
                      ...
                      builder: (dialogContext) {
                        return CommentModal(
                          ...
                          onComment: (commentText) async {
                            await dialogContext
                                .read<CoralSpeciesActionProvider>()
                                .addComment(
                                  widget.species,
                                  commentText,
                                  'Anonymous',
