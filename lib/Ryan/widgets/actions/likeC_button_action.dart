...
class LikeCButtonAction extends StatefulWidget {
  final CoralSpecies species;
  final bool isLiked;
  final double iconSize;

  const LikeCButtonAction({
    super.key,
  ...
  @override
  State<LikeCButtonAction> createState() => _LikeCButtonActionState();
}

class _LikeCButtonActionState extends State<LikeCButtonAction> {
  double _scale = 1.0;
