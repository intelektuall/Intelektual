...
class _SavedActionsScreenState extends State<SavedActionsScreen>
    with SingleTickerProviderStateMixin, AnalyticsScreenTracking {
  ...
  @override
  String get screenName => 'SavedActionsScreen';
  ...
  Future<void> _loadAllData() async {
    final coralProvider =
        Provider.of<CoralSpeciesActionProvider>(context, listen: false);
    final marineProvider =
        Provider.of<MarineSpeciesActionProvider>(context, listen: false);

    await coralProvider.loadActions();
    await marineProvider.loadActions();
        ...
        body: Stack(
          ...
          children: [
            ...
            if (_isLoading)
              ...
              Padding(
                padding: const EdgeInsets.only(top: kToolbarHeight + 90, bottom: 16),
                child: TabBarView(
